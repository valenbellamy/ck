...
function Graphismes({ data, transitionStatus, entry, exit }) {
  ...
  return (
    ...
    >
      ...
      <div className="projet">
        <section className="">
          <div ref={topEl}>
            <h1 className="c-black">Graphismes</h1>
...
export const query = graphql`
  query {
    img1: file(relativePath: { eq: "graphismes/Graphisme_1.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
    ...
    img2: file(relativePath: { eq: "graphismes/Graphisme_2.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    img3: file(relativePath: { eq: "graphismes/Graphisme_3.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    img4: file(relativePath: { eq: "graphismes/Graphisme_4.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    img5: file(relativePath: { eq: "graphismes/Graphisme_5.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
    ...
    img6: file(relativePath: { eq: "graphismes/Graphisme_6.jpg" }) {
      childImageSharp {
        fluid(quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
